...
@section('content')
    <div class="overflow">
      <header class="jumbotron jumbotron-fluid edit-sell1-jumbotron">
        @include('navbar')
        <div class="frontpage">
          <div class="col-lg-12">
            ...
            <div class="container">
              ...
              <div class="col-lg-8 profile">
                <div class="sell">
                  ...
                  <div class="sell-btns">
                    <a class="sell-btn1" href="/edit-sell1"
                      >List your item as a free resource?</a
                    >
                    <a class="sell-btn2" href="/edit-sell2"
                ...
                <div class="free-resource container">
                  ...
                  <div class="sell-btns">
                    <a class="sell-btn" href="/edit-sell2">Continue</a>
                  </div>
                </div>
              </div>
            </div>
