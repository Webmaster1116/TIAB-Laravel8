...
@section('content')
    <div class="overflow">
      <header class="jumbotron jumbotron-fluid sell-jumbotron sell2-jumbotron">
        @include('navbar')
        <div class="sell-frontpage">
          <div class="sell container">
            ...
            <div class="sell-btns">
              <a class="sell-btn1 sell-btn-nocolor" href="/sell-1"
                >List your item as a free resource?</a
              >
              <a class="sell-btn2 sell-btn-color" href="/sell-2"
            ...
            <div class="sell-title">
              ...
              <span class="sell-descript"
                >If your item is a hard good and you will be posting to buyers
                then please include the postage cost as part of the total price
                of your item. You can provide the specific cost of postage added
                to your total price in the description above.</span
              >
            </div>
            <div class="sell-title">
            ...
            <div class="sell-title">
              ...
              <input type="text" placeholder="$" />
              <span class="sell-descript"
                >Make sure that the discount price is lower than your original
                price above, not just lower than your final listing price</span
              >
            </div>
            <div class="sell-title">
              ...
              <input type="text" placeholder="$" />
              <span class="sell-descript"
                >The listing price is the price of your discounted item once
                live, TeachInABox adds a small admin fee to your item which
                TeachInABox takes out once a sale has been made</span
              >
            </div>
          </div>
